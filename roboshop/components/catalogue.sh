...
cd /home/roboshop && rm -f /tmp/catalogue && unzip /tmp/catalogue.zip &>>/tmp/roboshop.log && mv catalogue-main catalogue &>>/tmp/roboshop.log
STAT $?
...
sed -i -e 's/MONGO_DNSNAME/mongodb.connection.internal/' /home/roboshop/catalogue/systemd.service && mv /home/roboshop/catalogue/systemd.service /etc/systemd/system/catalogue.service
STAT $?
